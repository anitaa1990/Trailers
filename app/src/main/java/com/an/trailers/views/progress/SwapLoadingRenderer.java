package com.an.trailers.views.progress;
...
public class SwapLoadingRenderer extends LoadingRenderer {
    ...
    private static final float DEFAULT_BALL_RADIUS = 4.5f;
    ...
    private void init(Context context) {
        mWidth = BaseUtils.dip2px(context, DEFAULT_WIDTH);
        mHeight = BaseUtils.dip2px(context, DEFAULT_HEIGHT);
        mBallRadius = BaseUtils.dip2px(context, DEFAULT_BALL_RADIUS);
        mStrokeWidth = BaseUtils.dip2px(context, DEFAULT_STROKE_WIDTH);
